...
class Settings(BaseSettings):
    ...
    ollama_profile: str = Field(default="low_gpu", alias="SAIF_OLLAMA_PROFILE")
    ...
    ai_debug: bool = Field(default=True, alias="SAIF_AI_DEBUG")
    store_full_ai_prompts: bool = Field(default=True, alias="SAIF_STORE_FULL_AI_PROMPTS")
    store_full_ai_responses: bool = Field(default=True, alias="SAIF_STORE_FULL_AI_RESPONSES")
    store_agent_reactions: bool = Field(default=True, alias="SAIF_STORE_AGENT_REACTIONS")
    ...
    max_parallel_agents: int = Field(default=1, alias="SAIF_MAX_PARALLEL_AGENTS")
    max_parallel_tools: int = Field(default=1, alias="SAIF_MAX_PARALLEL_TOOLS")
    ...
    max_payloads_per_parameter: int = Field(default=5, alias="SAIF_MAX_PAYLOADS_PER_PARAMETER")
    max_runtime_seconds_per_tool: int = Field(default=300, alias="SAIF_MAX_RUNTIME_SECONDS_PER_TOOL")
    max_runtime_seconds_for_adaptive_tool: int = Field(default=600, alias="SAIF_MAX_RUNTIME_SECONDS_FOR_ADAPTIVE_TOOL")
    max_parameters_per_endpoint: int = Field(default=5, alias="SAIF_MAX_PARAMETERS_PER_ENDPOINT")
    max_endpoints_per_family: int = Field(default=10, alias="SAIF_MAX_ENDPOINTS_PER_FAMILY")
    max_ai_payload_decisions_per_tool: int = Field(default=3, alias="SAIF_MAX_AI_PAYLOAD_DECISIONS_PER_TOOL")
    max_total_requests_per_tool: int = Field(default=100, alias="SAIF_MAX_TOTAL_REQUESTS_PER_TOOL")
    ...
    dashboard_host: str = Field(default="0.0.0.0", alias="SAIF_DASHBOARD_HOST")
    dashboard_port: int = Field(default=8787, alias="SAIF_DASHBOARD_PORT")
    dashboard_allow_remote: bool = Field(default=True, alias="SAIF_DASHBOARD_ALLOW_REMOTE")
    dashboard_no_auth_explicitly_allowed: bool = Field(default=True, alias="SAIF_DASHBOARD_NO_AUTH_EXPLICITLY_ALLOWED")
    dashboard_access_log: bool = Field(default=False, alias="SAIF_DASHBOARD_ACCESS_LOG")
