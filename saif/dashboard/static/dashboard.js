...
document.querySelectorAll('[data-preset]').forEach(button => {
  button.addEventListener('click', () => {
    ...
    form.elements.profile.value = preset === 'crapi-full' ? 'crapi' : 'auto';
    form.elements.mode.value = preset === 'gray-box' ? 'gray-box' : 'black-box';
    if (preset === 'crapi-full') form.elements.mode.value = 'gray-box';
    form.elements.full.checked = preset === 'crapi-full' || preset === 'gray-box';
    ...
    form.elements.destructive_test_policy.value = preset === 'crapi-full' ? 'lab_full_allowed' : (preset === 'gray-box' ? 'test_owned_only' : 'detect_only');
    form.elements.enable_destructive_tests.checked = preset === 'crapi-full';
    form.elements.allow_test_owned_object_creation.checked = preset === 'crapi-full';
    form.elements.confirm_destructive_testing.checked = false;
    form.elements.allow_account_generation.checked = preset === 'crapi-full';
    form.elements.allow_authenticated_testing.checked = preset === 'crapi-full' || preset === 'gray-box';
    form.elements.allow_authorization_testing.checked = form.elements.allow_authenticated_testing.checked;
    form.elements.allow_payload_testing.checked = preset === 'crapi-full' || preset === 'gray-box';
